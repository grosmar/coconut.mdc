...
TestView.prototype = $extend(coconut_ui_View.prototype,{
	render: function(__data__) {
		...
		var __s = __f.forKey(model.get_keyt2(),function() {
			...
			var this11 = new tink_core_MPair(s,o);
			return this11;
		});
...
$hxClasses["TestModel"] = TestModel;
TestModel.__name__ = ["TestModel"];
TestModel.__interfaces__ = [coconut_data_Model];
TestModel.prototype = {
	key0: null
	,key1: null
	,key2: null
	...
	,set_activeTabIndex: function(param) {
		this.__coco_activeTabIndex.set(param);
		return param;
	}
...
$hxClasses["coconut.ui.tools.Compare"] = coconut_ui_tools_Compare;
coconut_ui_tools_Compare.__name__ = ["coconut","ui","tools","Compare"];
...
mdc_TabBar.prototype = $extend(coconut_ui_View.prototype,{
	...
	,render: function(attr) {
		...
		}, spellcheck : __v_0.spellcheck, style : __v_0.style, tabIndex : __v_0.tabIndex, title : __v_0.title},[attr.tabs,vdom_VDom.h("span",{ className : vdom__$Attr_ClassName_$Impl_$.ofString("mdc-tab-bar__indicator"), key : vdom__$Attr_Key_$Impl_$.ofObj(this)},null)]);
	}
...
$hxClasses["tink.pure._List.FilterResult_Impl_"] = tink_pure__$List_FilterResult_$Impl_$;
tink_pure__$List_FilterResult_$Impl_$.__name__ = ["tink","pure","_List","FilterResult_Impl_"];
...
tink_pure__$List_List_$Impl_$.__properties__ = {get_length:"get_length"};
