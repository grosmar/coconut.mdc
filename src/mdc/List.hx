...
class List
{
	...
	return @hxx '<i class={attr.className.add(["mdc-list-item__start-detail" => true, "material-icon" => true, "mdc-ripple-surface" => !attr.noRipple])} data-mdc-ripple-is-unbounded={attr.unboundedRipple} {...attr}>{children}</i>';
